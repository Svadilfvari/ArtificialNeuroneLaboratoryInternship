...
% FS  Variant of LIF.m (fast-spiking neuron) that also returns the model constants.
%   [Vtemps, AMPFS, Lambda1, Lambda2, T] = FS(Iex, DC, Fe, Fsp, Vpp)
%   Iex is accepted for convenience but not used; see LIF.m for the other arguments.
